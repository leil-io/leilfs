...
///
/// Adapter over the in-memory chunk engine in chunks.{h,cc}: each method forwards
/// to the corresponding free function (the in-memory engine API). The engine
/// remains the single source of truth for the in-memory logic.
