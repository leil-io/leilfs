...
const static std::unordered_map<std::string, std::string> defaultOptionsMaster = {
    ...
    {"SYSLOG_IDENT", "leil-master"},
    {"LOCK_MEMORY", "0"},
    {"NICE_LEVEL", "-19"},
    {"TOPOLOGY_FILENAME", ETC_PATH "/leil-topology.cfg"},
...
const static std::unordered_map<std::string, std::string> defaultOptionsCS = {
    ...
    {"HDD_CONF_FILENAME", ETC_PATH "/leil-hdd.cfg"},
    {"HDD_TEST_FREQ", "10.0"},
