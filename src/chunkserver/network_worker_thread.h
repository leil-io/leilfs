...
inline std::atomic<uint32_t> gMaxBlocksPerHddReadJob;
inline std::atomic<uint32_t> gMaxBlocksPerHddWriteJob;
...
public:
	...
	static constexpr uint32_t kDefaultMaxBlocksPerHddReadJob = 16;

	static constexpr uint32_t kDefaultWriteBufferingSize_mb = 0;
	static constexpr uint32_t kDefaultMaxBlocksPerHddWriteJob = 16;
	static constexpr uint32_t kMinBlocksPerHddWriteJob = 1;
	static constexpr uint32_t kMaxBlocksPerHddWriteJob = 64;
