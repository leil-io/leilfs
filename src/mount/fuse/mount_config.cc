...
"    -o malloctrimperiod=MSEC    set period of malloc trim in milliseconds. This option can "
				"be useful in memory-constrained scenarios. When equal to 0 the periodic "
				"trimming is disabled (default: %u)\n"
