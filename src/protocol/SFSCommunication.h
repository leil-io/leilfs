...
#define SFSBLOCKSINCHUNKBITS MSB(SFSBLOCKSINCHUNK)
#define SFSSIGNATURE "SFS"
#define SAUSIGNATURE "SAU"
#define SFSBLOCKBITS MSB(SFSBLOCKSIZE)
#define SFSBLOCKMASK (SFSBLOCKSIZE - 1)
#define SFSCHUNKSIZE (SFSBLOCKSIZE * SFSBLOCKSINCHUNK)
#define SFSCHUNKBITS (SFSBLOCKSINCHUNKBITS + SFSBLOCKBITS)
#define SFSCHUNKMASK (SFSCHUNKSIZE - 1)
#define SFSCHUNKBLOCKMASK (SFSCHUNKMASK ^ SFSBLOCKMASK)
#define SFSHDRSIZE (4 * SFSBLOCKSINCHUNK + 1024)

#if ((1 << SFSBLOCKSINCHUNKBITS) != SFSBLOCKSINCHUNK)
#  error "Wrong value of SFSBLOCKSINCHUNK: only powers of two (max 67108864) are supported"
#endif
#if ((1 << SFSBLOCKBITS) != SFSBLOCKSIZE)
...
#define SFS_MAX_FILE_SIZE (((uint64_t)(SFSCHUNKSIZE))<<31)

#define SFS_INODE_REUSE_DELAY 86400
...
#if defined(SAUNAFS_WIRESHARK_PLUGIN) || !defined(__cplusplus)
...
#define SAUNAFS_LOCK_UNLOCK    1
#define SAUNAFS_LOCK_SHARED    2
#define SAUNAFS_LOCK_EXCLUSIVE 4
...
// SFS uses Linux limits
#define SFS_XATTR_NAME_MAX 255
#define SFS_XATTR_SIZE_MAX 65536
#define SFS_XATTR_LIST_MAX 65536

/// field values: serverstatus
#define SAU_METADATASERVER_STATUS_MASTER 1
#define SAU_METADATASERVER_STATUS_SHADOW_CONNECTED 2
#define SAU_METADATASERVER_STATUS_SHADOW_DISCONNECTED 3

// Metalogger specific messages.

/// field values: filenum
#define DOWNLOAD_METADATA_SFS 1
#define DOWNLOAD_CHANGELOG_SFS 11
#define DOWNLOAD_CHANGELOG_SFS_1 12
#define DOWNLOAD_SESSIONS_SFS 2
...
// 0x041C
#define SAU_MATOML_END_SESSION (1000U + 52)
/// -
...
// 0x0429
#define SAU_MLTOMA_REGISTER_SHADOW (1000U + 65)
/// version==0 vershex:32 timeout:32 metadataversion:64

// 0x042A
#define SAU_MATOML_REGISTER_SHADOW (1000U + 66)
/// version==0 status:8
/// version==1 vershex:32 metadataversion:64

// 0x42B
#define SAU_MLTOMA_CHANGELOG_APPLY_ERROR (1000U + 67)
/// status:8

// 0x42C
#define SAU_MATOML_CHANGELOG_APPLY_ERROR (1000U + 68)
/// status:8

// 0x42D
#define SAU_MLTOMA_CLTOMA_PORT (1000U + 69)
/// port:16
...
// 0x044E
#define SAU_CSTOMA_REGISTER_SPACE (1000U + 102U)
...
// 0x047f
#define SAU_CSTOMA_REPLICATE_CHUNK (1000U + 151U)
...
// 0x0489
#define SAU_CSTOMA_TRUNCATE (PROTO_BASE + 1000U + 161U)
/// version==0 chunkid:64 chunktype:8 status:8
/// version==1 chunkid:64 chunktype:16 status:8
...
// 0x04B1
#define SAU_CSTOCL_READ_STATUS (1000U + 201U)
/// chunkid:64 status:8

// 0x04B2
#define SAU_CSTOCL_READ_DATA (1000U + 202U)
/// chunkid:64 offset:32 size:32 crc:32 data:BYTES[size]

// 0x04B3
#define SAU_CLTOCS_PREFETCH (1000U + 203U)
/// version==0 chunkid:64 chunkversion:32 chunktype:8 offset:32 size:32
/// version==1 chunkid:64 chunkversion:32 chunktype:16 offset:32 size:32
...
// 0x04BE
#define SAU_CLTOCS_TEST_CHUNK (1000U + 214U)
/// version==0 chunkid:64 chunkversion:32 chunktype:8
/// version==1 chunkid:64 chunkversion:32 chunktype:16
...
// 0x04E3
#define SAU_CSTOCS_GET_CHUNK_BLOCKS_STATUS (1000U + 251U)
...
/// length==12+SFSBLOCKSINCHUNK*4 chunkid:64 chunkversion:32 checksums:(SFSBLOCKSINCHUNK * [checksum:32])
...
//0x0598
#define SAU_CLTOMA_FUSE_READ_CHUNK (1000U + 432U)
/// msgid:32 inode:32 chunkindex:32

//0x0599
#define SAU_MATOCL_FUSE_READ_CHUNK (1000U + 433U)
/// version==0 msgid:32 status:8
...
// 0x059A
#define SAU_CLTOMA_FUSE_WRITE_CHUNK (1000U + 434U)
/// version==0 msgid:32 inode:32 chunkindex:32 lockid:32

// 0x059B
#define SAU_MATOCL_FUSE_WRITE_CHUNK (1000U + 435U)
/// version==0 msgid:32 status:8
...
// 0x059C
#define SAU_CLTOMA_FUSE_WRITE_CHUNK_END (1000U + 436U)
...
// 0x059D
#define SAU_MATOCL_FUSE_WRITE_CHUNK_END (1000U + 437U)
/// msgid:32 status:8
...
// 0x05A9
#define SAU_MATOCL_FUSE_SETGOAL (1000U + 449U)
/// version==0 msgid:32 status:8
...
// 0x05B9
#define SAU_MATOCL_FUSE_TRUNCATE (1000U + 465U)
/// version==0 msgid:32 status:8
...
//0x01E2
#define SAU_CLTOMA_CHUNKS_INFO (1000U + 482U)
/// msgid:32 inode:32 chunkindex:32

//0x01E3
#define SAU_MATOCL_CHUNKS_INFO (1000U + 483U)

//0x01E4
#define SAU_CLTOMA_UPDATE_CREDENTIALS (1000U + 484U)
...
// 0x5D9
#define SAU_CLTOMA_FUSE_TRUNCATE_END (1000U + 497U)
/// msgid:32 inode:32 uid:32 gid:32 filelength:64 lockid:32

// 0x5DA
#define SAU_MATOCL_FUSE_TRUNCATE_END (1000U + 498U)
/// version==0 msgid:32 status:8
/// version==1 msgid:32 attr:35B
...
// 0x05F2
#define SAU_CLTOMA_METADATASERVERS_LIST (1000U + 522U)
/// -
...
// 0x05F9
#define SAU_CLTOMA_IOLIMIT (1000U + 529U)
/// msgid:32 cfgversion:32 group:STDSTRING bytes:64

// 0x05FA
#define SAU_MATOCL_IOLIMIT (1000U + 530U)
/// msgid:32 cfgversion:32 group:STDSTRING bytes:64

// 0x05FB
#define SAU_CLTOMA_FUSE_SET_ACL (1000U + 531U)
/// msgid:32 inode:32 uid:32 gid:32 acltype:8 mode:16 isextended:8 extendedacl:(isextended ? ExtendedAcl : ---)

// 0x05FC
#define SAU_MATOCL_FUSE_SET_ACL (1000U + 532U)
/// msgid:32 status:8

// 0x05FD
#define SAU_CLTOMA_FUSE_GET_ACL (1000U + 533U)
/// msgid:32 inode:32 uid:32 gid:32 acltype:8

// 0x05FE
#define SAU_MATOCL_FUSE_GET_ACL (1000U + 534U)
/// version==0 msgid:32 status:8
/// version==1 msgid:32 mode:16 isextended:8 extendedacl:(isextended ? ExtendedAcl : ---)

// 0x05FF
#define SAU_CLTOMA_FUSE_DELETE_ACL (1000U + 535U)
/// msgid:32 inode:32 uid:32 gid:32 acltype:8

// 0x0600
#define SAU_MATOCL_FUSE_DELETE_ACL (1000U + 536U)
/// msgid:32 status:8

// 0x0601
#define SAU_CLTOMA_FUSE_SET_QUOTA (1000U + 537U)
/// msgid:32 uid:32 gid:32 limits:(vector<QuotaEntryKey, limit:64>)

// 0x0602
#define SAU_MATOCL_FUSE_SET_QUOTA (1000U + 538U)
/// msgid:32 status:8

// 0x0603
#define SAU_CLTOMA_FUSE_DELETE_QUOTA (1000U + 539U)
/// msgid:32 uid:32 gid:32 limits:(vector<QuotaEntryKey>)

// 0x0604
#define SAU_MATOCL_FUSE_DELETE_QUOTA (1000U + 540U)
/// msgid:32 status:8

// 0x0605
#define SAU_CLTOMA_FUSE_GET_QUOTA (1000U + 541U)
...
// 0x0606
#define SAU_MATOCL_FUSE_GET_QUOTA (1000U + 542U)
/// version==0 msgid:32 status:8
/// version==1 msgid:32 limits:(vector<QuotaOwnerAndLimits>)

// 0x0607
#define SAU_CLTOMA_IOLIMITS_STATUS (1000U + 543U)
/// msgid:32

// 0x0608
#define SAU_MATOCL_IOLIMITS_STATUS (1000U + 544U)
/// msgid:32 cfgversion:32 period:32 accumulation:32 subsystem:STDSTRING groupslimits:(vector<STDSTRING, uint64_t>)

// 0x0609
#define SAU_CLTOMA_METADATASERVER_STATUS (1000U + 545U)
/// msgid:32

// 0x060A
#define SAU_MATOCL_METADATASERVER_STATUS (1000U + 546U)
/// msgid:32 serverstatus:8 metadataversion:64

// 0x060D
#define SAU_CLTOMA_LIST_GOALS (1000U + 547U)
/// dummy:8

// 0x060C
#define SAU_MATOCL_LIST_GOALS (1000U + 548U)
/// goals:(vector<uint16_t, STDSTRING, STDSTRING>)

// 0x060D
#define SAU_CLTOMA_CSERV_LIST (1000U + 549U)
/// dummy:8

// 0x060E
#define SAU_MATOCL_CSERV_LIST (1000U + 550U)
/// chunkservers:(vector<ChunkserverListEntry>)

// 0x060F
#define SAU_CLTOMA_HOSTNAME (1000U + 551U)
/// -

// 0x0610
#define SAU_MATOCL_HOSTNAME (1000U + 552U)
/// hostname:STDSTRING

// 0x0611
#define SAU_CLTOMA_ADMIN_REGISTER_CHALLENGE (1000U + 553U)
/// -

// 0x0612
#define SAU_MATOCL_ADMIN_REGISTER_CHALLENGE (1000U + 554U)
/// challenge:BYTES[32]

// 0x0613
#define SAU_CLTOMA_ADMIN_REGISTER_RESPONSE (1000U + 555U)
/// response:BYTES[16]

// 0x0614
#define SAU_MATOCL_ADMIN_REGISTER_RESPONSE (1000U + 556U)
/// status:8

// 0x0615
#define SAU_CLTOMA_ADMIN_BECOME_MASTER (1000U + 557U)
/// -

// 0x0616
#define SAU_MATOCL_ADMIN_BECOME_MASTER (1000U + 558U)
/// status:8

// 0x0617
#define SAU_CLTOMA_ADMIN_STOP_WITHOUT_METADATA_DUMP (1000U + 559U)
/// -

// 0x0618
#define SAU_MATOCL_ADMIN_STOP_WITHOUT_METADATA_DUMP (1000U + 560U)
/// status:8

// 0x0619
#define SAU_CLTOMA_ADMIN_RELOAD (1000U + 561U)
/// -

// 0x061A
#define SAU_MATOCL_ADMIN_RELOAD (1000U + 562U)
/// status:8

// 0x061B
#define SAU_CLTOMA_ADMIN_SAVE_METADATA (1000U + 563U)
/// asynchronous:8

// 0x061C
#define SAU_MATOCL_ADMIN_SAVE_METADATA (1000U + 564U)
/// status:8

// 0x061D
#define SAU_CLTOMA_ADMIN_RECALCULATE_METADATA_CHECKSUM (1000U + 565U)
/// asynchronous:8
...
// 0x624
#define SAU_MATOCL_FUSE_FLOCK (1000U + 572U)
/// msgid:32 status:8

// 0x625
#define SAU_CLTOMA_FUSE_GETLK (1000U + 573U)
/// msgid:32 inode:32 owner:64 type:16 start:64 len:64 pid:32

// 0x626
#define SAU_MATOCL_FUSE_GETLK (1000U + 574U)
/// version==0 msgid:32 status:8
/// version==1 msgid:32 type:16 start:64 len:64 pid:32

// 0x627
#define SAU_CLTOMA_FUSE_SETLK (1000U + 575U)
/// msgid:32 inode:32 owner:64 reqid:32 type:16 start:64 len:64 pid:32

// 0x628
#define SAU_MATOCL_FUSE_SETLK (1000U + 576U)
/// msgid:32 status:8

// 0x629
#define SAU_CLTOMA_FUSE_FLOCK_INTERRUPT (1000U + 577U)
/// messageid:32 owner:64 inode:32 reqid:32

// 0x62A
#define SAU_CLTOMA_FUSE_SETLK_INTERRUPT (1000U + 578U)
/// messageid:32 owner:64 inode:32 reqid:32

// 0x62B
#define SAU_CLTOMA_MANAGE_LOCKS_LIST (1000U + 579U)
/// version==0 type:8 pending:8 start:64 max:64
/// version==1 inode:32 type:8 pending:8 start:64 max:64

// 0x62C
#define SAU_MATOCL_MANAGE_LOCKS_LIST (1000U + 580U)
/// list:(vector<lockInfo>)

// 0x62D
#define SAU_CLTOMA_MANAGE_LOCKS_UNLOCK (1000U + 581U)
/// version==0 type:8 inode:32 sessionid:32 owner:64 start:64 end:64
/// version==1 type:8 inode:32

// 0x62E
#define SAU_MATOCL_MANAGE_LOCKS_UNLOCK (1000U + 582U)
/// status:8
...
// 0x632
#define SAU_MATOCL_RECURSIVE_REMOVE (1000U + 586U)
/// msgid:32 status:8

// 0x633
#define SAU_CLTOMA_FUSE_GETDIR (1000U + 587U)
/// msgid:32 status:8

// 0x634
#define SAU_MATOCL_FUSE_GETDIR (1000U + 588U)
/// msgid:32 status:8

// 0x635
#define SAU_CLTOMA_LIST_TASKS (1000U + 589U)
/// dummy:8

// 0x636
#define SAU_MATOCL_LIST_TASKS (1000U + 590U)
/// goals:(vector<JobInfo>)

// 0x637
#define SAU_CLTOMA_STOP_TASK (1000U + 591U)
/// msgid:32 taskid:32

// 0x638
#define SAU_MATOCL_STOP_TASK (1000U + 592U)
/// msgid:32 status:8

// 0x639
#define SAU_CLTOMA_REQUEST_TASK_ID (1000U + 593U)
/// msgid:32

// 0x63A
#define SAU_MATOCL_REQUEST_TASK_ID (1000U + 594U)
/// msgid:32 taskid:32

// 0x63B
#define SAU_CLTOMA_FUSE_SNAPSHOT (1000U + 595U)
/// msgid:32 jobid:32 inode:32 inode_dst:32 name_dst:NAME uid:32 gid:32 canoverwrite:8 ignore_missing_src:8 initial_batch:32

// 0x63C
#define SAU_MATOCL_FUSE_SNAPSHOT (1000U + 596U)
/// msgid:32 status:8

// 0x63D
#define SAU_CLTOMA_LIST_DEFECTIVE_FILES (1000U + 597U)
/// flags:8 first_entry:64 number_of_entries:64

// 0x63E
#define SAU_MATOCL_LIST_DEFECTIVE_FILES (1000U + 598U)
/// last_entry_index:64 files:(vector<DefectiveFileInfo>)

// 0x63f
#define SAU_CLTOMA_FUSE_GETRESERVED (1000U + 599U)
/// msgid:32 off:32 max_entries:32

// 0x640
#define SAU_MATOCL_FUSE_GETRESERVED (1000U + 600U)
/// msgid:32 entries:(vector<NamedInodeEntry>)

// 0x641
#define SAU_CLTOMA_FUSE_GETTRASH (1000U + 601U)
/// msgid:32 off:32 max_entries:32
...
// 0x645
#define SAU_CLTOMA_FULL_PATH_BY_INODE (1000U + 605U)

// 0x646
#define SAU_MATOCL_FULL_PATH_BY_INODE (1000U + 606U)

// 0x647
#define SAU_CLTOMA_FUSE_GET_SELF_QUOTA (1000U + 607U)
