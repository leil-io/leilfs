...
for f in goal2/*; do
	assert_eventually_prints "" "saunafs_command fileinfo '$f' | grep ':${info[chunkserver0_port]}'" "60 sec"
	assert_eventually_prints 2 "saunafs_command fileinfo '$f' | grep copy | wc -l" "60 sec"
done
