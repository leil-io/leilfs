...
# Give some time for the writes to begin and trigger the EIO on CS 0, then stop the master server
...
# The part in the first chunkserver should have been removed, and should have not even been reported
# to the master
