...
assert_awk_finds '/no valid copies/' "$(saunafs_command fileinfo file)"
...
assert_awk_finds '/[0-9A-F]+_00000002/' "$(saunafs_command fileinfo file)"
...
assert_awk_finds_no '/[0-9A-F]+_00000003/' "$(saunafs_command fileinfo file)"
