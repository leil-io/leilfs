...
mkdir dir_ec
saunafs_command setgoal -r ec43 dir_ec
...
assert_failure "saunafs_command fileinfo dir_ec/file | grep 'not enough parts available'"

saunafs_chunkserver_daemon 3 stop

saunafs_command fileinfo dir_ec/file | grep "not enough parts available"
