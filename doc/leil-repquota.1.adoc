...
leil-repquota, leil-setquota - retrieves and sets quotas for specified
users and groups
...
[verse]
*leil setquota* -d 'SOFT-LIMIT-SIZE' 'HARD-LIMIT-SIZE'
...
available - one can set SESFLAG_ALLCANCHANGEQUOTA in leil-exports.cfg file. A
...
*setquota* sets quotas for a user or a group on LeilFS. The quotas are not
