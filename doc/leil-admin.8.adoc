...
leil-admin, leil-probe - LeilFS monitoring and administration tool

== SYNOPSIS

**leil-admin** __COMMAND__ [OPTIONS...] [ARGUMENTS...]

== NOTES

**leil-probe** is deprecated, leil-admin should be used instead.
...
*info* __<master ip> <master port>__::
  Prints statistics concerning the LeilFS installation. +
  --porcelain +
    Make the output parsing-friendly. +
