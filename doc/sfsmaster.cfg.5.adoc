...
*TLS_CERT_FILE*::
Path to the TLS certificate file the master server will use for TLS connections
(there is no default value).

*TLS_KEY_FILE*::
Path to the TLS private key file the master server will use for TLS connections
(there is no default value).
