...
leil-globaliolimits.cfg - global I/O limiting configuration

== DESCRIPTION

The file *leil-globaliolimits.cfg* contains configuration of the global I/O
limiter.
...
cgroups group *<group>*. In LeilFS, subgroups of *<group>* constitute
...
renegotiation period (see leil-master.cfg(5)).
