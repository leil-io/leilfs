...
A line naming a plugin that is not installed is rejected and the chunkserver
refuses to start. Whether the two-path form is required depends on the plugin.
