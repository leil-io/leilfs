...
- *saunafs-uraft-helper* (the helper script): floating IP network details and local `sfsmaster`
  management.
...
Increase `URAFT_GETVERSION_TIMEOUT` and ensure the local `sfsmaster` responds promptly to
